...
dependencies {
    ...
    implementation(projects.features.connectors.api)
    implementation(projects.features.voicelibrary.api)
    implementation(projects.features.agentmanagement.api)
    implementation(projects.features.skills.api)
    ...
    testImplementation(projects.features.voicelibrary.test)
