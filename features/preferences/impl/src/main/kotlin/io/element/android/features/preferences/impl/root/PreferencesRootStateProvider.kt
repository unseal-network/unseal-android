...
fun aPreferencesRootState(
    ...
    creditBalanceLoadState: CreditBalanceLoadState = CreditBalanceLoadState.Unavailable,
    aiAssistant: SettingsAiAssistantRenderModel = SettingsAiAssistantRenderModel.from(creditBalanceLoadState),
